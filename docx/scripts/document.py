...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(self, xml_path, rsid: str, author: str = "reporter_agent", initials: str = "C"):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "reporter_agent")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "reporter_agent")
